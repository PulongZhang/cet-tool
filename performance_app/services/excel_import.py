...
OBJECTIVE_HEADERS = ["工号", "姓名", "一级部门", "二级部门", "三级部门", "四级部门", "勤奋月1", "勤奋月2", "勤奋月3", "考勤异常次数", "日志异常次数", "学习时长"]
...
def parse_workbook(file: BinaryIO, field_map: dict[str, str], required_headers: list[str] | None = None) -> list[dict]:
